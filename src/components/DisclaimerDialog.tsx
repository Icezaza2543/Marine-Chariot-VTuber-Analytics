      ...
      <article className="disclaimer-dialog__panel">
        ...
        <div className="disclaimer-dialog__body">
          ...
          <p>
            ...
            แต่สิทธิ์ดังกล่าวครอบคลุมเฉพาะซอฟต์แวร์ของโปรเจกต์นี้ ไม่ครอบคลุมข้อมูลช่อง แบรนด์ ชื่อ
            ภาพลักษณ์ วิดีโอ thumbnail โพสต์ หรือสื่อใด ๆ ของ Marine Chariot
          </p>
          <p>
            ...
            ไม่ควรนำข้อมูลไปใช้ซ้ำ เผยแพร่ต่อ ขาย ดัดแปลง
